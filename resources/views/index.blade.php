	...
	<div class="page-box-content">
			...
			<div class="container">
			  <div class="row">
				<div class="col-xs-6 col-md-2 col-lg-3 logo-box">
				  <div class="logo">
						<a href="index.html">
							<img src="{{asset('')}}img/logo/RDEVIS_LOGO.jpg" class="logo-img" alt="RDEVIS Logo">
						</a>
				  </div>
				</div><!-- .logo-box -->
					  ...
					  <div class="search-header hidden-600">
						<a href="#">
						  <svg x="0" y="0" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
							...
							<image src="{{asset('')}}img/png-icons/search-icon.png" alt="" width="16" height="16" style="vertical-align: top;">
						  </svg>
						</a>
					  </div><!-- .search-header
					  ...
					  --><div class="phone-header hidden-600">
						<a href="#">
						  <svg x="0" y="0" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
							...
							<image src="{{asset('')}}img/png-icons/phone-icon.png" alt="" width="16" height="16" style="vertical-align: top;">
						  </svg>
						</a>
					  </div><!-- .phone-header -->
					</div><!-- .header-icons -->
						  ...
						  <ul class="nav navbar-nav navbar-center">
							<li class="parent">
							  ...
							  <ul class="sub">
								...
								<li><a href="home-2.html">Our Group companies</a></li>
								<li><a href="home-3.html">Management</a></li>
								<li><a href="home-4.html">Locations</a></li>
								<li><a href="home-5.html">Values</a></li>
								<li><a href="home-5.html">Certifications</a></li>
							...
							<li class="parent">
							  ...
							  <ul class="sub">
								...
								<li><a href="sidebar-blocks.html">Images & Videos</a></li>
								<li><a href="full-width.html">Events</a></li>
							...
							<li class="parent">
							  ...
							  <ul class="sub">
								...
								<li><a href="sidebar-blocks.html">Jobs</a></li>
								<li><a href="full-width.html"> Apply</a></li>
			...
			<div class="rev_slider tp-banner" data-version="5.0.7">
			  <ul>
				<li data-delay="7000" data-transition="fade" data-slotamount="7" data-masterspeed="2000">
				  <div class="elements">
					<div class="tp-caption"
					  ...
					  style="z-index: 2">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img1.png" width="217" height="172" alt="">
					</div>
					...
					<div class="tp-caption"
					  ...
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img2.png" width="71" height="104" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:1000;e:Power4.easeOut"
					  ...
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img3.png" width="764" height="76" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:1000;e:Power4.easeOut"
					  data-transform_out="y:bottom;s:500;e:Power1.easeIn">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img4.png" width="247" height="71" alt="">
					</div>
		        ...
		        data-transform_in="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 100%;s:700;e:Power4.easeOut"
					  ...
					  style="z-index: 3">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img5.png" width="166" height="107" alt="">
					</div>
		        ...
		        data-transform_in="y:top;s:1000;e:Power4.easeOut"
					  data-transform_out="y:top;s:500;e:Power1.easeIn"
					  style="z-index: 1">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img6.png" width="104" height="157" alt="">
					</div>
		        ...
		        data-transform_in="x:left;s:1000;e:Power4.easeOut"
					  data-transform_out="x:left;s:500;e:Power1.easeIn"
					  style="z-index: 3">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img7.png" width="95" height="197" alt="">
					</div>
		        ...
		        data-transform_in="x:left;s:1000;e:Power4.easeOut"
					  data-transform_out="y:top;s:500;e:Power1.easeIn"
					  style="z-index: 3">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img8.png" width="275" height="240" alt="">
					</div>
		        ...
		        data-transform_in="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;s:1000;e:Power4.easeOut"
					  ...
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img9.png" width="101" height="101" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:1000;e:Power4.easeOut"
					  data-transform_out="y:bottom;s:500;e:Power1.easeIn"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img10.png" width="64" height="77" alt="">
					</div>
		        ...
		        data-transform_in="x:left;s:500;e:Power4.easeOut"
					  data-transform_out="x:left;s:500;e:Power1.easeIn"
					  style="z-index: 3">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img11.png" width="35" height="14" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:1000;e:Power4.easeOut"
					  data-transform_out="y:bottom;s:500;e:Power1.easeIn"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img12.png" width="33" height="25" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:1000;e:Power4.easeOut"
					  data-transform_out="y:bottom;s:500;e:Power1.easeIn"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img13.png" width="33" height="25" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:1000;e:Power4.easeOut"
					  data-transform_out="y:bottom;s:500;e:Power1.easeIn"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider4-img14.png" width="33" height="25" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:1000;e:Power4.easeOut"
				  ...
				  <img src="{{asset('')}}content/img/slider/rs-slider4-bg.jpg" alt="" data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
				</li>
		        ...
		        data-transform_in="y:bottom;s:1000;e:Power4.easeOut"
					  data-transform_out="y:bottom;s:500;e:Power1.easeIn"
					  style="z-index: 3">
					  <img src="{{asset('')}}content/img/slider/rs-slider1-phone.png" width="375" height="434" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:1000;e:Power4.easeOut"
					  ...
					  style="z-index: 1">
					  <img src="{{asset('')}}content/img/slider/rs-slider1-phone-bg.png" width="160" height="296" alt="">
					</div>
		        ...
		        data-transform_in="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;s:1200;e:Power3.easeOut"
					  ...
					  style="z-index: 5">
					  <img src="{{asset('')}}content/img/slider/rs-slider1-html5-1.png" width="99" height="111" alt="">
					</div>
		        ...
		        data-transform_in="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;s:1200;e:Power3.easeOut"
					  ...
					  data-end="3300"
					  style="z-index: 5">
					  <img src="{{asset('')}}content/img/slider/rs-slider1-html5-2.png" width="72" height="91" alt="">
					</div>
		        ...
		        data-transform_in="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;s:1200;e:Power3.easeOut"
					  ...
					  style="z-index: 5">
					  <img src="{{asset('')}}content/img/slider/rs-slider1-css3.png" width="72" height="91" alt="">
					</div>
		        ...
		        data-transform_in="x:0;y:55;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;s:1000;e:Power0.easeOut"
				  ...
				  <img src="{{asset('')}}content/img/slider/rs-slider1-bg.jpg" alt="" data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
				</li>
		        ...
		        data-transform_in="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:-360;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;s:1000;e:Power4.easeOut"
					  ...
					  data-end="14000"
					  style="z-index: 3">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-img.png" width="731" height="284" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:400;e:Power4.easeOut"
					  ...
					  data-captionhidden="on"
					  style="z-index: 2">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-homepage1.png" width="277" height="280" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:400;e:Power4.easeOut"
					  ...
					  data-captionhidden="on"
					  style="z-index: 2">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-homepage2.png" width="277" height="280" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:400;e:Power4.easeOut"
					  ...
					  data-captionhidden="on"
					  style="z-index: 2">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-homepage3.png" width="277" height="280" alt="">
					</div>
		        ...
		        data-transform_in="y:bottom;s:400;e:Power4.easeOut"
					  ...
					  data-captionhidden="on"
					  style="z-index: 2">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-homepage4.png" width="277" height="280" alt="">
					</div>
		        ...
		        data-transform_in="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:1;transformPerspective:600;transformOrigin:50% 50%;s:1;e:Power0.easeOut"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-one.png" width="110" height="168" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-two.png" width="110" height="168" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-three.png" width="110" height="168" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-four.png" width="110" height="168" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-quadrate1.png" width="48" height="48" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-quadrate2.png" width="79" height="79" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-quadrate3.png" width="110" height="107" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-quadrate4.png" width="140" height="138" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-quadrate5.png" width="170" height="168" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-quadrate6.png" width="200" height="200" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
					  ...
					  data-captionhidden="on"
					  style="z-index: 4">
					  <img src="{{asset('')}}content/img/slider/rs-slider2-quadrate7.png" width="231" height="231" alt="">
					</div>
				  </div>
				  
				  <img src="{{asset('')}}content/img/slider/rs-slider2-bg.jpg" alt="" data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
				</li>
		        ...
		        data-transform_in="x:left;s:1500;e:Power4.easeOut"
					  ...
					  style="z-index: 1">
					  <img src="{{asset('')}}content/img/slider/rs-slider3-pig.png" width="576" height="393" alt="">
					</div>
		        ...
		        data-transform_in="x:left;s:1500;e:Power4.easeOut"
					  data-transform_out="x:left;s:1000;e:Power1.easeIn"
					  style="z-index: 3">
					  <img src="{{asset('')}}content/img/slider/rs-slider3-pig2.png" width="576" height="393" alt="">
					</div>
		        ...
		        data-transform_in="y:top;s:500;e:Power0.easeOut"
					  data-transform_out="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;s:100;e:Power1.easeIn"
					  style="z-index: 2">
					  <img src="{{asset('')}}content/img/slider/rs-slider3-coin.png" width="64" height="68" alt="">
					</div>
		        ...
		        data-transform_in="y:top;s:500;e:Power0.easeOut"
				  ...
				  <img src="{{asset('')}}content/img/slider/rs-slider3-bg.jpg" alt="" data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
				</li>
			  </ul>
		...
		<div class="banner-set load" data-autoplay-disable="true">
		  <div class="container">
			<div class="banners">
			  <a href="#" class="banner">
				<img src="{{asset('')}}content/img/banner1.jpg" width="253" height="158" alt="">
			  ...
			  <a href="#" class="banner">
				<img src="{{asset('')}}content/img/banner2.jpg" width="253" height="158" alt="">
			  ...
			  <a href="#" class="banner">
				<img src="{{asset('')}}content/img/banner3.jpg" width="253" height="158" alt="">
			  ...
			  <a href="#" class="banner">
				<img src="{{asset('')}}content/img/banner4.jpg" width="253" height="158" alt="">
			  ...
			  <a href="#" class="banner">
				<img src="{{asset('')}}content/img/banner5.jpg" width="253" height="158" alt="">
				<h2 class="title">Home Theater</h2>
				<div class="description">Nunc condimentum eros vel nibh consectetur dignissim. Ut ante neque, ullamcorper ac feugiat at, ullamcorper sagittis magna.</div>
			  </a>
			  <a href="#" class="banner">
				<img src="{{asset('')}}content/img/banner6.jpg" width="253" height="158" alt="">
				<h2 class="title">Multiroom</h2>
				<div class="description">Maecenas ac leo velit. Aliquam venenatis tellus in erat pellentesque ut dignissim turpis consequat. Fusce sit amet sagittis urna.</div>
			  </a>
			</div><!-- .banners -->
						...
						<div class="row">
						  <div class="carousel no-responsive gallery">
							<div class="col-sm-4 col-md-3">
							  <a class="gallery-images" rel="fancybox" href="{{asset('')}}content/img/office-1.jpg">
								<img src="{{asset('')}}content/img/office-1-270.jpg" width="270" height="135" alt="">
								<span class="bg-images"><i class="fa fa-search"></i></span>
							  </a>
							</div>
							<div class="col-sm-4 col-md-3">
							  <a class="gallery-images" rel="fancybox" href="{{asset('')}}content/img/office-2.jpg">
								<img src="{{asset('')}}content/img/office-2-270.jpg" width="270" height="135" alt="">
								<span class="bg-images"><i class="fa fa-search"></i></span>
							  </a>
							</div>
							<div class="col-sm-4 col-md-3">
							  <a class="gallery-images" rel="fancybox" href="{{asset('')}}content/img/office-3.jpg">
								<img src="{{asset('')}}content/img/office-3-270.jpg" width="270" height="135" alt="">
								<span class="bg-images"><i class="fa fa-search"></i></span>
							  </a>
							</div>
							<div class="col-sm-4 col-md-3">
							  <a class="gallery-images" rel="fancybox" href="{{asset('')}}content/img/office-4.jpg">
								<img src="{{asset('')}}content/img/office-4-270.jpg" width="270" height="135" alt="">
								<span class="bg-images"><i class="fa fa-search"></i></span>
							  </a>
							</div>
						  </div>
					  ...
					  <div class="row filter-elements">
						<div class="work-element web-design col-xs-12 col-sm-3 col-md-3">
						  <a href="portfolio-single.html" class="work">
							<img src="{{asset('')}}content/img/portfolio-1-270.jpg" width="270" height="197" alt="">
						...
						<div class="work-element graphic-design col-xs-12 col-sm-3 col-md-3">
						  <a href="portfolio-single.html" class="work">
							<img src="{{asset('')}}content/img/portfolio-2-270.jpg" width="270" height="197" alt="">
							<span class="shadow"></span>
							<div class="bg-hover"></div>
							<div class="work-title">
						...
						<div class="work-element ecommerce col-xs-12 col-sm-3 col-md-3">
						  <a href="portfolio-single.html" class="work">
							<img src="{{asset('')}}content/img/portfolio-3-270.jpg" width="270" height="197" alt="">
							<span class="shadow"></span>
							<div class="bg-hover"></div>
							<div class="work-title">
						...
						<div class="work-element graphic-design col-xs-12 col-sm-3 col-md-3">
						  <a href="portfolio-single.html" class="work">
							<img src="{{asset('')}}content/img/portfolio-4-270.jpg" width="270" height="197" alt="">
							<span class="shadow"></span>
							<div class="bg-hover"></div>
							<div class="work-title">
						...
						<div class="work-element graphic-design col-xs-12 col-sm-3 col-md-3">
						  <a href="portfolio-single.html" class="work">
							<img src="{{asset('')}}content/img/portfolio-5-270.jpg" width="270" height="197" alt="">
							<span class="shadow"></span>
							<div class="bg-hover"></div>
							<div class="work-title">
						...
						<div class="work-element ecommerce col-xs-12 col-sm-3 col-md-3">
						  <a href="portfolio-single.html" class="work">
							<img src="{{asset('')}}content/img/portfolio-6-270.jpg" width="270" height="197" alt="">
							<span class="shadow"></span>
							<div class="bg-hover"></div>
							<div class="work-title">
						...
						<div class="work-element ecommerce col-xs-12 col-sm-3 col-md-3">
						  <a href="portfolio-single.html" class="work">
							<img src="{{asset('')}}content/img/portfolio-7-270.jpg" width="270" height="197" alt="">
							<span class="shadow"></span>
							<div class="bg-hover"></div>
							<div class="work-title">
						...
						<div class="work-element web-design col-xs-12 col-sm-3 col-md-3">
						  <a href="portfolio-single.html" class="work">
							<img src="{{asset('')}}content/img/portfolio-8-270.jpg" width="270" height="197" alt="">
							<span class="shadow"></span>
							<div class="bg-hover"></div>
							<div class="work-title">
					  ...
					  <div class="panel-group multi-collapse" id="accordion2">
						<div class="panel panel-default active">
						  ...
						  <div id="collapse21" class="panel-collapse collapse in">
							<div class="panel-body">
							  <img class="replace-2x alignright" src="{{asset('')}}content/img/animations-100.png" width="100" height="62" alt="">
						...
						<div class="panel panel-default">
						  ...
						  <div id="collapse23" class="panel-collapse collapse">
							<div class="panel-body">
							  <img class="replace-2x alignleft" src="{{asset('')}}content/img/animations-100.png" width="100" height="62" alt="">
				...
				<div id="cm-video-bg" class="full-width-box bottom-padding">
				  <div class="fwb-bg fwb-video band-16">
					<video autoplay="" muted="" loop="">
					  <source src="{{asset('')}}content/video/video.mp4" type="video/mp4">
					  <source src="{{asset('')}}content/video/video.webm" type="video/webm">
					</video>
					...
					<div class="row">
					  <div class="carousel products">
						<div class="col-sm-3 col-md-3 product rotation">
						  <div class="default">
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-11.jpg" alt="" title="" width="270" height="270">
							</a>
						  ...
						  <div class="product-hover">
							...
							<div class="price">$1, 449.00</div>
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-11.jpg" alt="" title="" width="70" height="70">
							</a>
							<ul>
						...
						<div class="col-sm-3 col-md-3 product rotation">
						  <div class="default">
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-12.jpg" alt="" title="" width="270" height="270">
							</a>
							<div class="product-description">
							  <div class="vertical">
							<h3 class="product-name">
						  ...
						  <div class="product-hover">
							...
							<div class="price">$1, 449.00</div>
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-12.jpg" alt="" title="" width="70" height="70">
							</a>
							<ul>
							  <li>117 cm / 46"LCD TV</li>
							  <li>Full HD 3D &amp; 2D</li>
						...
						<div class="col-sm-3 col-md-3 product rotation">
						  <div class="default">
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-13.jpg" alt="" title="" width="270" height="270">
							</a>
							<div class="product-description">
							  <div class="vertical">
							<h3 class="product-name">
						  ...
						  <div class="product-hover">
							...
							<div class="price">$1, 449.00</div>
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-13.jpg" alt="" title="" width="70" height="70">
							</a>
							<ul>
							  <li>117 cm / 46"LCD TV</li>
							  <li>Full HD 3D &amp; 2D</li>
						...
						<div class="col-sm-3 col-md-3 product rotation">
						  <div class="default">
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-14.jpg" alt="" title="" width="270" height="270">
							</a>
							<div class="product-description">
							  <div class="vertical">
							<h3 class="product-name">
						  ...
						  <div class="product-hover">
							...
							<div class="price">$1, 449.00</div>
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-14.jpg" alt="" title="" width="70" height="70">
							</a>
							<ul>
							  <li>117 cm / 46"LCD TV</li>
							  <li>Full HD 3D &amp; 2D</li>
						...
						<div class="col-sm-3 col-md-3 product rotation">
						  <div class="default">
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-5.jpg" alt="" title="" width="270" height="270">
							</a>
							<div class="product-description">
							  <div class="vertical">
							<h3 class="product-name">
						  ...
						  <div class="product-hover">
							...
							<div class="price">$1, 449.00</div>
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-5.jpg" alt="" title="" width="70" height="70">
							</a>
							<ul>
							  <li>117 cm / 46"LCD TV</li>
							  <li>Full HD 3D &amp; 2D</li>
						...
						<div class="col-sm-3 col-md-3 product rotation">
						  <div class="default">
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-6.jpg" alt="" title="" width="270" height="270">
							</a>
							<div class="product-description">
							  <div class="vertical">
							<h3 class="product-name">
						  ...
						  <div class="product-hover">
							...
							<div class="price">$1, 449.00</div>
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-6.jpg" alt="" title="" width="70" height="70">
							</a>
							<ul>
							  <li>117 cm / 46"LCD TV</li>
							  <li>Full HD 3D &amp; 2D</li>
						...
						<div class="col-sm-3 col-md-3 product rotation">
						  <div class="default">
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-7.jpg" alt="" title="" width="270" height="270">
							</a>
							<div class="product-description">
							  <div class="vertical">
							<h3 class="product-name">
						  ...
						  <div class="product-hover">
							...
							<div class="price">$1, 449.00</div>
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-7.jpg" alt="" title="" width="70" height="70">
							</a>
							<ul>
							  <li>117 cm / 46"LCD TV</li>
							  <li>Full HD 3D &amp; 2D</li>
						...
						<div class="col-sm-3 col-md-3 product rotation">
						  <div class="default">
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-8.jpg" alt="" title="" width="270" height="270">
							</a>
							<div class="product-description">
							  <div class="vertical">
							<h3 class="product-name">
						  ...
						  <div class="product-hover">
							...
							<div class="price">$1, 449.00</div>
							<a href="shop-product-view.html" class="product-image">
							  <img src="{{asset('')}}content/img/product-8.jpg" alt="" title="" width="70" height="70">
							</a>
							<ul>
							  <li>117 cm / 46"LCD TV</li>
							  <li>Full HD 3D &amp; 2D</li>
				  ...
				  <div class="container">
					...
					<div class="row text-center">
					  <div class="col-sm-3 col-md-3 rotation employee">
						<div class="default">
						  <div class="image">
							<img src="{{asset('')}}content/img/team-1.jpg" alt="" title="" width="270" height="270">
						  </div>
					  ...
					  --><div class="col-sm-3 col-md-3 rotation employee">
						<div class="default">
						  <div class="image">
							<img src="{{asset('')}}content/img/team-2.jpg" alt="" title="" width="270" height="270">
						  </div>
						  <div class="description">
							<div class="vertical">
					  ...
					  --><div class="col-sm-3 col-md-3 rotation employee">
						<div class="default">
						  <div class="image">
							<img src="{{asset('')}}content/img/team-3.jpg" alt="" title="" width="270" height="270">
						  </div>
						  <div class="description">
							<div class="vertical">
					  ...
					  --><div class="col-sm-3 col-md-3 rotation employee">
						<div class="default">
						  <div class="image">
							<img src="{{asset('')}}content/img/team-4.jpg" alt="" title="" width="270" height="270">
						  </div>
						  <div class="description">
							<div class="vertical">
				  ...
				  <div class="row">
					<div class="col-sm-12 col-md-6 promo-partners bottom-padding">
					  ...
					  <div class="row manufactures manufactures-list">
						<div class="make-wrapper">
						  <a href="#" class="make">
							<img src="{{asset('')}}content/img/make-2.png" width="128" height="128" alt="">
						  </a>
						</div><!--
							
						--><div class="make-wrapper">
						  <a href="#" class="make">
							<img src="{{asset('')}}content/img/make-3.png" width="128" height="128" alt="">
						  </a>
						</div><!--
							
						--><div class="make-wrapper">
						  <a href="#" class="make">
							<img src="{{asset('')}}content/img/make-4.png" width="128" height="128" alt="">
						  </a>
						</div>
					  </div>
					...
					<div class="col-sm-12 col-md-6">
					  ...
					  <ul class="latest-posts">
						<li>
						  <img class="image img-circle replace-2x" src="{{asset('')}}content/img/product-1-84.jpg" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
						  <div class="meta">
						...
						<li>
						  <img class="image img-circle replace-2x" src="{{asset('')}}content/img/product-2-84.jpg" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
						  <div class="meta">
							<span>Mike Example</span>, 
							<span class="time">03.11.2013, 10:45:</span>
						  </div>
						...
						<li>
						  <img class="image img-circle replace-2x" src="{{asset('')}}content/img/product-3-84.jpg" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
						  <div class="meta">
							<span>Mike Example</span>, 
							<span class="time">03.11.2013, 10:45:</span>
						  </div>
