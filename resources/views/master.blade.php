<?php 
use App\Helpers\HeaderMenuData;
?>
<!doctype html>
				...
				<div class="row sidebar ">
					...
					<aside class="col-xs-12 col-sm-3 col-md-3 widget social  ">
						...
						<div class="pull-left">
							...
							<div class="social-list ">
								<a class="icon rounded icon-facebook " href="https://www.facebook.com/rdevisengineers/"
									target="_blank"><i class="fa fa-facebook fa-lg"></i></a>
								<a class="icon rounded icon-instagram "
									href="https://instagram.com/rdevis_engineers?utm_medium=copy_link"
									target="_blank"><i class="fa fa-instagram fa-lg"></i></a>
								<a class="icon rounded icon-google " href="#" target="_blank"><i
										class="fa fa-google fa-lg"></i></a>
								<a class="icon rounded icon-linkedin "
									href="https://www.linkedin.com/company/rdevis-engineers-pvt-ltd" target="_blank"><i
					...
					<aside class="col-xs-12 col-sm-9 col-md-7 widget links" style="padding-top: 0px">
						...
						<p style="padding-top: 20px" class="text-center">
							<center>{!! HeaderMenuData::fetchAddress()!!}</center>
						</p>
					</aside>
			...
			<div class="container">
				<div class="row">
					<div class="copyright text-center col-xs-12 col-sm-12 col-md-12">
						Copyright © <a href="" target="_blank" style="text-decoration:none;">Rdevis Engineers Pvt.
							Ltd.</a>
					</div>
