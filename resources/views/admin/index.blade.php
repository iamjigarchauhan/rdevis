...
<head>
	...
	<link href="{{asset('')}}admin_assets/css/bootstrap_limitless.min.css" rel="stylesheet" type="text/css">
	<link href="{{asset('')}}admin_assets/css/layout.min.css" rel="stylesheet" type="text/css">
	<link href="{{asset('')}}admin_assets/css/components.min.css" rel="stylesheet" type="text/css">
	<link href="{{asset('')}}admin_assets/css/colors.min.css" rel="stylesheet" type="text/css">
	<!-- /global stylesheets -->

	<!-- Core JS files -->
	<script src="{{asset('')}}admin_assets/js/main/jquery.min.js"></script>
	<script src="{{asset('')}}admin_assets/js/main/bootstrap.bundle.min.js"></script>
	<script src="{{asset('')}}admin_assets/js/plugins/loaders/blockui.min.js"></script>
	<!-- /core JS files -->

	<!-- Theme JS files -->
	<script src="{{asset('')}}admin_assets/js/plugins/visualization/d3/d3.min.js"></script>
	<script src="{{asset('')}}admin_assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
	<script src="{{asset('')}}admin_assets/js/plugins/forms/styling/switchery.min.js"></script>
	<script src="{{asset('')}}admin_assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	<script src="{{asset('')}}admin_assets/js/plugins/ui/moment/moment.min.js"></script>
	<script src="{{asset('')}}admin_assets/js/plugins/pickers/daterangepicker.js"></script>
	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
			<a href="index.html" class="d-inline-block">
				<img src="{{asset('')}}admin_assets/images/logo_light.png" alt="">
			</a>
		</div>
			...
			<ul class="navbar-nav">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								<li class="media">
									<div class="mr-3">
										<img src="{{asset('')}}admin_assets/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
						<img src="{{asset('')}}admin_assets/images/placeholders/placeholder.jpg" class="rounded-circle" alt="">
						<span>Victoria</span>
					</a>
