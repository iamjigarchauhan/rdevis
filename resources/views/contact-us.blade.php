				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-6 contact-info bottom-padding">
						...
						<div class="row">
							...
							<address class="col-sm-12 col-md-12">
								...
								<div class="row">
									...
									<div>Support: <a
											href="mailto:support@example.com">{{isset($data->id)?$data->support_email:''}}</a>
									</div>
									<div>Sales: <a
											href="mailto:manager@example.com">{{isset($data->id)?$data->sales_email:''}}</a>
									</div>
								</div>
						...
						<p class="font-18">We are India’s leading plant engineering company with continuous aim for high
							...
							among others.
							We are present pan-India with various branches at different locations.</p>
